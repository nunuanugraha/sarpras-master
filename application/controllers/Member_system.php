...
class Member_system extends PX_Controller {
	...
	function pinjam(){
		$this->check_login_peminjam();
		$data['userdata'] = $this->session_peminjam;
		$data['data'] = $this->model_basic->select_where_join('tbl_pinjam','tbl_pinjam.*,tbl_dokumen.no_dokumen','id_peminjam',$this->session_peminjam['id_peminjam'],'tbl_dokumen','tbl_pinjam.no_dokumen','tbl_dokumen.no_dokumen')->result();
	...
	function riwayat(){
		$this->check_login_peminjam();
		$data['userdata'] = $this->session_peminjam;
		$data['data'] = $this->model_basic->select_where_join_2('tbl_riwayat','tbl_riwayat.*,tbl_dokumen.no_dokumen as no_dokumen,tbl_peminjam.name as name_peminjam','tbl_riwayat.id_peminjam',$this->session_peminjam['id_peminjam'],'tbl_dokumen','tbl_riwayat.no_dokumen','tbl_dokumen.no_dokumen','tbl_peminjam','tbl_riwayat.id_peminjam','tbl_peminjam.id_peminjam')->result();
